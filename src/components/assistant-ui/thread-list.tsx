...
const ThreadListItem: FC = () => {
  const { isMobile, setOpenMobile } = useSidebar();
  return (
    <ThreadListItemPrimitive.Root className="aui-thread-list-item group flex h-9 cursor-pointer items-center gap-2 rounded-lg transition-all duration-150 hover:bg-muted focus-visible:bg-muted focus-visible:outline-none data-active:bg-muted">
